;(function ( global ) {
    ...
    function LinkedList( datum , addNodeLast ) {
        ...
        function removeNode( removeBy , removeMethod ) {
            ...
            if ( ( removeMethod === 'value' && removeBy != null )
                   || ( removeMethod === 'index' && isNumeric( removeBy ) && removeBy >= 0 && removeBy <= lastNodeIndex() )
                   || ( removeMethod === 'node' && removeBy != null )
                ) {
                nodeToDelete = forEachNode( function( nodeValue , nodeIndex , node ) {
                    return ( removeMethod === 'value' && nodeValue === removeBy )
                            || ( removeMethod === 'index' && nodeIndex === removeBy )
                            || ( removeMethod === 'node' && node === removeBy )
                        ? ( nodeIndexToDelete = nodeIndex , true )
                        : false;
                });
        ...
        function newNode( value , nextNode ) {
            ...
            if ( value != null && nextNode !== undefined ) {
                node = Object.create( Object.prototype , {
                    'value'       : { 'value' : value , 'enumerable' : true , 'configurable' : false , 'writable' : false } ,
                    'next'        : { 'value' : next , 'enumerable' : true , 'configurable' : false , 'writable' : false } ,
                    'setNextNode' : { 'value' : setNextNode , 'enumerable' : false , 'configurable' : false , 'writable' : false }
                });
            }
